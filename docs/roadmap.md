...
| **E2 Codex** | [E2](https://github.com/watchthelight/shatterfish/milestone/3) | [#46](https://github.com/watchthelight/shatterfish/issues/46) | 10 stories | Every fact the Brain needs about the game, generated from the pinned code and never drifting | One Gradle task regenerates `codex/<tag>/` and CI fails on drift | next |
