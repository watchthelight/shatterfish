...
Story issues exist for E1 through E5 today (E1, E2 and E3 are closed; E4 is current; E5 is next,
with its sixteen stories at [#146](https://github.com/watchthelight/shatterfish/issues/146) through
[#161](https://github.com/watchthelight/shatterfish/issues/161)).
...
| **E3 Rig** | [E3](https://github.com/watchthelight/shatterfish/milestone/4) | [#47](https://github.com/watchthelight/shatterfish/issues/47) | 12 stories | Any claim about a Brain can be measured, published and reproduced by a stranger | A random-agent Baseline is published and a deliberately worse Brain is rejected by the Sequential test | done |
| **E4 Baseline brain** | [E4](https://github.com/watchthelight/shatterfish/milestone/5) | [#48](https://github.com/watchthelight/shatterfish/issues/48) | 14 stories | A hand-built bot that plays the sewers competently | The Warrior kills Goo on at least 75% of the `goo` Seed set with a lower bound of at least 70% | current |
| **E5 Overlay v1** | [E5](https://github.com/watchthelight/shatterfish/milestone/6) | [#49](https://github.com/watchthelight/shatterfish/issues/49) | 16 stories | A person can watch the bot think, step it, and take the controls mid-fight | A full sewers Run watched end to end with a mid-fight takeover and no desync | next |
