...
| 17 | What the pick-up and equip Policies weigh: a pick-up's turn, gear's one-in-three-in-ten curse, the strength penalty, the equip turn, the curse that keeps a piece on, and a cursed piece's worst proc. | `pick-up`, `equip` | [identification: "What the pick-up and equip Policies weigh"](rules/identification.md) |
