...
final class FreshRun {
    ...
    static void forget() {
        ...
        // The upstream statics a Run can leave behind for the next, the snake's dodge counter among
        // them (issue #167). Starting a game resets them itself (NewGame.begin); a resumed game is
        // loaded rather than begun, so it needs them put back here, as a fresh process would have them.
        RunStatics.reset();
    }
