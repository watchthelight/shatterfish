...
record Memory(long waits, int deepest, List<Fact> facts, List<Found> found, List<Held> held, List<String> known,
     ...
     * a refusal spends no turn (Hero.java:1308-1313: the "locked_door" message and {@code ready()} at
     * :1309-1310, {@code return false} with no {@code spend()} at :1313), so nothing else would ever
     * tell the two apart.
     */
