 ...
 * a resolution check in {@code build.gradle}, and {@code BrainBoundaryTest} all enforce this,
 * along with the quieter channels a package rule alone would miss: files, sockets, reflection,
 * runtime name lookup, the process environment, a clock and a generator of its own. The brain
 * itself is not written until E1-E3 exist.
 */
