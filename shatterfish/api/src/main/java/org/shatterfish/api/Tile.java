 ...
 * ({@code core/.../tiles/DungeonTileSheet.java:419-470}, and the chasm and water tilemaps,
 * {@code :73-84}), named as the game names the terrain drawn that way
 * ({@code core/.../levels/Terrain.java:26-71}), plus {@link #NONE} for a cell the player has never
 ...
 * {@link #EMPTY}, and the decoration that keeps water's pass-through, added at {@code v4.0.0}, is
 * {@link #WATER}, which is what the sheet draws for it and not what the cell is for
 * ({@code DungeonTileSheet.java:442}); a door the hero locked is a {@link #LOCKED_DOOR} by visual
 * and by name ({@code core/.../levels/Level.java:1609-1611}). The two secret terrains are drawn as
