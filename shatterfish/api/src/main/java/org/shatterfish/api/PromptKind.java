 ...
 *
 * <p>{@link #MESSAGE} is the plain message the game shows and a person taps away: the sign the hero
 * stepped onto, the story of a floor, the feeling's own window. Story 1.10 made such a window a
