 ...
 * ({@code core/.../effects/BlobEmitter.java:59-72}; ADR-0006). The blobs the game marks always
 * visible are drawn on a remembered cell as well, and have no representation in this version:
 * six of them at {@code v4.0.0}, the alchemy pot, well water, the wall of light, Tengu's fire and
 * shocker blobs and the skeleton key's wall.
 *
